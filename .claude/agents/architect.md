...
- Guard the data-flow rule in `CLAUDE.md`: UI → hooks → lib services → Supabase/AI clients
...
- Keep ADRs short — a paragraph of context, the decision, and the consequence is enough
