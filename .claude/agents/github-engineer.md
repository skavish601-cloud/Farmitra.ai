...
2. Keep CI fast — parallelize independent checks, cache dependencies
...
## Best Practices
- Required status checks on `main` should match exactly what `CONTRIBUTING.md` asks contributors to run locally — no surprises
