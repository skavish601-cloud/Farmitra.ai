...
This is a quick-reference snapshot of the live Supabase schema. Treat `docs/database/` as the authoritative, detailed source â€” update both when the schema changes.
