...
**What FarmMitra is *not*:** a general-purpose chatbot, a React Native mobile app (an earlier concept used this â€” superseded, see `CHANGELOG.md`), or a system that should ever guess at scheme amounts, prices, or chemical dosages rather than admit uncertainty.
