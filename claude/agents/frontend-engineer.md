...
- Consume `lib/` services and hooks â€” never call Supabase or AI providers directly from components
...
## Best Practices
- Icon-only controls are avoided given the low-literacy target audience â€” pair icons with text
